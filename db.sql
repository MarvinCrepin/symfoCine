...
INSERT INTO `film` VALUES (7,'Mourir peut attendre','https://picsum.photos/360','<div>James Bond n\'est plus en service et profite d\'une vie tranquille en Jamaïque. Mais son répit est de courte durée car l\'agent de la CIA Felix Leiter fait son retour pour lui demander son aide.&nbsp;</div>','mourir-peut-attendre'),(8,'Matrix','https://picsum.photos/350','<div>Film de science fiction précurseur sur le hacking et la RA.</div>','matrix'),(9,'Matrix 2','https://fr.web.img3.acsta.net/medias/nmedia/00/02/53/34/affiche.jpg','<div>Néo est dans le monde virtuel (la matrice).</div>','matrix-2'),(10,'La Ligne Verte','https://fr.web.img4.acsta.net/medias/nmedia/18/66/15/78/19254683.jpg','<div>Paul Edgecomb, pensionnaire centenaire d\'une maison de retraite, est hanté par ses souvenirs. Gardien-chef du pénitencier de Cold Mountain.</div>','la-ligne-verte');
